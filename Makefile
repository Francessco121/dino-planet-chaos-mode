...
CPPFLAGS := -nostdinc -D_LANGUAGE_C -DMIPS -D_MIPS_SZLONG=32 -DF3DEX_GBI_2 \
		    -I include -I lib/dino-recomp-mod-api/include -I lib/dino-recomp-decomp-bridge/include -I lib/dino-recomp-decomp-bridge/dinosaur-planet/include
